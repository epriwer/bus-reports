...
app.controller('busReportsCtrl', ['$scope', function($scope) {
  ...
  $scope.busReports = { "data":[ { "organisation":"Sydney Buses", "date":"25/09/2015", "busData":[ { "busId":"42612", "routeVariant":"891 2 1", "deviationFromTimetable":77 }, 
  { "busId":"29016", "routeVariant":"400 1 1", "deviationFromTimetable":340 }, { "busId":"90467", "routeVariant":"393 1 1", "deviationFromTimetable":220 }, 
  { "busId":"88836", "routeVariant":"M20 1 0", "deviationFromTimetable":-287 }, { "busId":"79367", "routeVariant":"L21 2 1", "deviationFromTimetable":347 } ] }, 
...
app.filter('formatRouteVariant', function($sce) {
  return function(input) {
    if(angular.isUndefined(input) || input === null)
      return $sce.trustAsHtml('');
    
    var routeVariantParts = input.split(' ');
    if(routeVariantParts.length != 3)
      return $sce.trustAsHtml(input);
    else
      return $sce.trustAsHtml('<b>' + routeVariantParts[0] + '</b> ' + routeVariantParts[1] + ' ' + routeVariantParts[2]);
  }
});